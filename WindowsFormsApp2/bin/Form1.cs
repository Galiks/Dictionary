...
namespace WindowsFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        {
            string UnusedWord = Dictionary.RusRandomWordOfDictionary();

            //while (Dictionary.UsedWord[UnusedWord])
            //    UnusedWord = Dictionary.RusRandomWordOfDictionary();

            //Dictionary.UsedWord[UnusedWord] = true;

                

            richTextBox1.Text = "Введите перевод слова: " + UnusedWord;
        }
            ...
            if (richTextBox1.TextLength > 0)
            {
                if (textBox1.TextLength > 0)
                {
                    ...
                    if (UserWord == OriginalWord)
                    {
                        ...
                        label1.Refresh();
                        Dictionary.UsedWord[OriginalWord] = true;
                    }
